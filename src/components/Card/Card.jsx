...
const CardProduct = (props) => {
  ...
  if (count < 1) {
    ...
    return (
            ...
            <Button className='cart__button' variant="secondary" onClick={ ()=> setCount(count + 1) }>
            <svg 
              width='25px'
              height='25px' 
              aria-hidden="true"
        ...
        <span className='quantity__card'>{count}</span>
            ...
            <svg
              ...
              role="img" xmlns="http://www.w3.org/2000/svg" 
              viewBox="0 0 448 512">
              <path fill="#fff" d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"></path></svg>
              </Button>
          </ButtonGroup>
                  </Card.Body>
                  </Card>
